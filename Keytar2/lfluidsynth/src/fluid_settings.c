...
new_fluid_num_setting(fluid_real_t min, fluid_real_t max, fluid_real_t def,
...
/** returns 1 if the value has been register correctly, zero
    otherwise */
int fluid_settings_register_num(fluid_settings_t* settings, char* name, fluid_real_t def,
			       fluid_real_t min, fluid_real_t max, int hints,
...
int fluid_settings_setnum(fluid_settings_t* settings, const char* name, fluid_real_t val)
{
  int type;
  void* value;
  fluid_num_setting_t* setting;
...
void fluid_settings_getnum_range(fluid_settings_t* settings, char* name, fluid_real_t* min, fluid_real_t* max)
{
  int type;
  void* value;
  char* tokens[MAX_SETTINGS_TOKENS];
