...
Audio::STATUS Audio::init()
{
	...
	//if(AUDIO_OK != BSP_AUDIO_IN_OUT_Init(INPUT_DEVICE_INPUT_LINE_1, OUTPUT_DEVICE_HEADPHONE, kSampleRate, kSampleBits, kSampleChannels))
...
// The BSP functions supplied in CUBEMX only support PDM microphone but I want to use
